...
function addNextDetailSection(){
    ...
    previousDivDetailSectionID = previousDivDetailSection.attr("id");

    htmlLinkRemove = `
           <a class="btn fas fa-times-circle fa-2x icon-dark"
            title="Remove this detail" href="javascript:removeDetailSectionById('${previousDivDetailSectionID}')"></a>`;
