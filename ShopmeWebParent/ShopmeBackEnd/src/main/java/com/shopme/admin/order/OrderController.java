...
public class OrderController {
	...
	public String listByPage(
	    ...
	    loadCurrencySetting(request, settingService);
	...
	private void loadCurrencySetting(HttpServletRequest request, SettingService settingService2) {
	...
	public String viewOrderDetails(@PathVariable("id") Integer id, Model model, 
		...
		try {
			...
			boolean isVisibleForAdminOrSalePerson = false;
			
			if(!loggedUser.hasRole("ADMIN") || !loggedUser.hasRole("Saleperson")) {
				isVisibleForAdminOrSalePerson = true;
			}
			
			model.addAttribute("isVisibleForAdminOrSalePerson", isVisibleForAdminOrSalePerson);
