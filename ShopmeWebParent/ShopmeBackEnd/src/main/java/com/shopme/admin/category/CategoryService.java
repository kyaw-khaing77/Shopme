...
public class CategoryService {
	...
	private List<Category> listHierarchicalCategories(List<Category> rootCategories,String sortDir){
		...
		for(Category rootCategory : rootCategories) {
			...
			Set<Category> children = sortSubCategoeries(rootCategory.getChildren(),sortDir);
	...
	private void listSubHierarchicalCategories(List<Category> hierarchicalCategories,Category parent,int subLevel,String sortDir) {
		 ...
		 Set<Category> children = sortSubCategoeries(parent.getChildren(),sortDir);
		  for(Category subcategory : children) {
			  String name = "";
			  ...
			  listSubHierarchicalCategories(hierarchicalCategories,subcategory, newlevel,sortDir);
		  }
	}
