...
public class CategoryController {
	...
	public String listByPage(@PathVariable("pageNum")Integer pageNum,String sortDir,
	...
	public void exportCategoriesWithCsv(HttpServletResponse response) throws IOException {
        CategoryCsvExporter csvExporter = new CategoryCsvExporter();
        List<Category> listCategories = service.listCategoriesUsedInForm();
        csvExporter.export(listCategories, response);
