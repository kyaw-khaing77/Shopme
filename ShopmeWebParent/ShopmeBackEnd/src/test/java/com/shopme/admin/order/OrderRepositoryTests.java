...
public class OrderRepositoryTests {
	...
	public void testCreateNewOrderWithSingleProduct() {
		...
		orderDetail1.setShippingCost(10);
		orderDetail1.setQuantity(1);
		orderDetail1.setSubtotal(product.getPrice());
	...
	/*
	 * @Test public void testAddTrackWithStatusNewToOrder() { Integer orderId = 11;
	 * Order order = repo.findById(orderId).get();
	 * 
	 * OrderTrack newTrack = new OrderTrack(); newTrack.setOrder(order);
	 * newTrack.setUpdatedTime(new Date()); newTrack.setStatus(OrderStatus.NEW);
	 * newTrack.setNotes(OrderStatus.NEW.defaultDescription());
	 * 
	 * List<OrderTrack> orderTracks = order.getOrderTracks();
	 * orderTracks.add(newTrack);
