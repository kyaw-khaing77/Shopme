...
public class CountryRestControllerTests {
	...
	@Test
	@WithMockUser(username = "nam@codejave.net",password = "java2020",roles = "ADMIN")
    ...
    public void testCreateCountry() throws JsonProcessingException, Exception {
		...
		MvcResult result=mockMvc.perform(post(url).contentType("application/json").content(objectMapper.writeValueAsString(country))
								   .with(csrf()))
							       .andDo(print())
							       .andExpect(status().isOk())
							       .andReturn();
    ...
    public void testdeleteCountry() throws Exception {
		...
		Optional<Country> deletedCountry = repo.findById(countryId);
